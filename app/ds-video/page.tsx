...
const COURSE_NAME = 'Data Science';
const VIDEO_PATH = '/assets/media/videos/DS.mp4';

interface QuizQuestion { question: string; answer: string; }
interface User { email: string; }

export default function DsVideoPage() {
        ...
        <div className="video-page">
          ...
          <div className="video-info">
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px', flexWrap: 'wrap' }}>
              ...
              <span style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>⏱ 12 Weeks</span>
              <span style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>👨‍🏫 Live Sessions</span>
            </div>
            <h1>Data Science</h1>
            <p>Explore data analysis, visualization, statistics, and machine learning concepts with Python and real datasets.</p>
