...
const VIDEO_PATH = '/assets/media/videos/UIUX.mp4';

interface QuizQuestion { question: string; answer: string; }
interface User { email: string; }

export default function UiUxVideoPage() {
      ...
      <main>
        <div className="video-page">
          ...
          <div className="video-info">
            ...
            <h1>UI / UX Design</h1>
            <p>Understand user research, wireframing, prototyping, and visual design principles to create great digital experiences.</p>
