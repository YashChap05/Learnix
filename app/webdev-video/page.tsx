...
const VIDEO_PATH = '/assets/media/videos/Web_dev.mp4';

interface QuizQuestion { question: string; answer: string; }
interface User { email: string; }

export default function WebDevVideoPage() {
        ...
        <div className="video-page">
          ...
          <div className="video-info">
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px', flexWrap: 'wrap' }}>
              ...
              <span style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>⏱ 8 Weeks</span>
              <span style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>👨‍🏫 Live Sessions</span>
            </div>
            <h1>Web Development</h1>
            <p>Learn HTML, CSS, JavaScript and build responsive, modern websites from scratch. This introductory course walks through core web technologies step by step.</p>
